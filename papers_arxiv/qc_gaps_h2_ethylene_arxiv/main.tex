...
\texttt{zor\_scenes/}\allowbreak\texttt{scene\_ethylene\_quasidegen/} in the
source repository; see the public HTML companion~\citep{inZORNDQCGaps2026}.
...
{\small\url{https://dumitrunovic-svg.github.io/inZOR-ND/tests/qc_gaps_h2_ethylene_unified/}}

Ethylene 3D technical page:\newline
{\small\url{https://dumitrunovic-svg.github.io/inZOR-ND/tests/qc_gaps_h2_ethylene_unified/ethylene_3d_zor.html}}

Repository (tests and brochure source):\newline
{\small\url{https://github.com/dumitrunovic-svg/inZOR-ND}}.
\end{sloppypar}
